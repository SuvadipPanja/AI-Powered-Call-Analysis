...
const DEFAULT_QUERY_CATEGORIES = [
  ...
  { name: "Credit Card Rewards/Redemption", description: "Redeem or ask about credit card reward points, cashback, points value or offers — not a problem/complaint.", keywords: "reward points, rewards, redeem, redemption, cashback, cash back, points redemption, redeem points, reward redemption, points balance", color: "#f59e0b" },
